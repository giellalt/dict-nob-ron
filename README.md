# Dictionary for nob — ron

This repository contains source files for a dictionary from Norwegian Bokmål to Romanian. The content is licensed under the  license.
